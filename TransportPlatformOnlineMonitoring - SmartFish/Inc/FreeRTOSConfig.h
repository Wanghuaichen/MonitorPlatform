 ...
 * @brief 借鉴FreeRTOS的Demo以及正点原子的config文件进行适配于本公司的配置文件
 *
...
/**
 * @brief FreeRTOS与运行时间和任务状态收集有关的配置选项
 */
#if (DEBUG_MODE == 1)
...
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY	5                       //!< 系统可管理的最高中断优先级，优先级大于它则系统不能屏蔽
#define configKERNEL_INTERRUPT_PRIORITY 		( configLIBRARY_LOWEST_INTERRUPT_PRIORITY << (8 - configPRIO_BITS) )
#define configMAX_SYSCALL_INTERRUPT_PRIORITY 	( configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY << (8 - configPRIO_BITS) )


/**
 * @brief FreeRTOS与中断服务函数有关的配置选项
 */
